...
echo.on('alert', (level, tick) => {
    if (level === 1) {
        ...
        currentDistance_1 = (diff * MICROSECDONDS_PER_CM * ADJUSTMENT_FACTOR)+1;
        module.exports.startTick = null; // Reset
    }
});

console.log(`Ultrasonic2 distance: ${currentDistance_1.toFixed(2)} cm`);
